...
// Version 82: a paragraph that begins with an ideographic space (U+3000) does
// not get the reader's auto first-line indent (the space itself is the indent,
// matching Kindle). Applies to vertical (verticalIndent) and horizontal
// (textIndent injection).
// ⚠️ フォーク: 上流v0.3.8.2の矢印直立化(U+2190-2193)はKindle版と表示を一致させるため意図的に取り込まない。
