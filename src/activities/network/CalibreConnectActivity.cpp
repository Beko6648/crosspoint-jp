...
void CalibreConnectActivity::render(RenderLock&&) {
  ...
  if (state == CalibreConnectState::SERVER_STARTING) {
    renderer.drawCenteredTextOffset(UI_12_FONT_ID, top, tr(STR_CALIBRE_STARTING), true, centerOffset);
  } else if (state == CalibreConnectState::ERROR) {
    renderer.drawCenteredTextOffset(UI_12_FONT_ID, top, tr(STR_CONNECTION_FAILED), true, centerOffset,
                                    EpdFontFamily::BOLD);
    ...
    renderer.drawText(UI_12_FONT_ID, contentLeft, y, tr(STR_CALIBRE_SETUP), true, EpdFontFamily::BOLD);
    y += heightText12 + metrics.verticalSpacing * 2;

    renderer.drawText(SMALL_FONT_ID, contentLeft, y, tr(STR_CALIBRE_INSTRUCTION_1));
    renderer.drawText(SMALL_FONT_ID, contentLeft, y + height, tr(STR_CALIBRE_INSTRUCTION_2));
    renderer.drawText(SMALL_FONT_ID, contentLeft, y + height * 2, tr(STR_CALIBRE_INSTRUCTION_3));
    renderer.drawText(SMALL_FONT_ID, contentLeft, y + height * 3, tr(STR_CALIBRE_INSTRUCTION_4));

    y += height * 3 + metrics.verticalSpacing * 4;
    renderer.drawText(UI_12_FONT_ID, contentLeft, y, tr(STR_CALIBRE_STATUS), true, EpdFontFamily::BOLD);
    y += heightText12 + metrics.verticalSpacing * 2;
