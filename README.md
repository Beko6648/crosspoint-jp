...
>
> **修正済み（要約）**
> - **ページ描画・画像**: 画像ページ高速化(14秒→4秒)・インライン画像のサンセリフ対応(2026-08-19)・インライン画像の文字化 / XTCH表紙グレースケール（上流取り込み済み）
> - **フォント**: 拡張フォント「NotoSerifJp-Ext」とフォントビルドスクリプト拡張(2026-08-18)
> - **キャッシュ**: キャッシュ生成終了時のフォントキャッシュ解放（上流取り込み済み）
> - **縦書き・インデント**: 段落配置のJustify固定 / 全角空白行頭の二重インデント解消 / 二重`loadVertData`呼び出し解消(2026-08-19)
> - **目次・章**: ファイル途中を指す目次項目の除外
> - **その他のUI**: ページ送り中インジケータ / 全角空白(U+3000)の表示
>
