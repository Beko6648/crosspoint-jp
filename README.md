...
> **Beko6648フォークの開発状況メモ**
>
> **ベースの上流バージョン**: 上流 **`v0.7.3`**。フォーク独自機能（インライン画像・ページ送り中インジケータ・章一覧のTOC除外・縦書き段落配置の固定・三点リーダー改行修正・ファイル移動など）を維持しています。**変更の詳細・技術的経緯は [フォーク開発状況メモ(詳細)](docs/fork-notes.md) を参照してください。**
>
