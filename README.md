...
> **Beko6648フォークの開発状況メモ**
>
> Xteink X3用に、本家`v0.4.0`(コミット`2590620`)をベースに統合した開発版で、フォーク独自機能（インライン画像・ページ送り中インジケータ・章一覧のTOC除外・縦書き段落配置の固定など）を維持しています。GitHub Releasesで配布中の最新版は`yomuka-v0.4.0-fork1.3`(上流ベース`v0.4.0`)です。**変更の詳細・技術的経緯は [フォーク開発状況メモ(詳細)](docs/fork-notes.md) を参照してください。**
>
> **修正済み（要約）**
>
> **ページ描画・画像**
