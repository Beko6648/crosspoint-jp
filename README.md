...
> **Beko6648フォークの開発状況メモ**
>
> **ベースの上流バージョン**: 上流 **`v0.5.0`**（FreeInk表示SDK移行済み・`open-x4-sdk`→`freeink-sdk`差し替え）。GitHub Releasesで配布中の最新版は`yomuka-v0.5.0-fork1.6`。フォーク独自機能（インライン画像・ページ送り中インジケータ・章一覧のTOC除外・縦書き段落配置の固定など）を維持しています。**変更の詳細・技術的経緯は [フォーク開発状況メモ(詳細)](docs/fork-notes.md) を参照してください。**
>
