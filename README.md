...
> **Beko6648フォークの開発状況メモ**
>
> Xteink X3用に、本家`v0.3.7`(コミット`124a5da`)から分岐し、本家`v0.3.8.1`の修正（文字重なり・英文空白）と`v0.3.8.2`の機能（全角空白表示）を取り込んだうえで、以下の修正を加えています。フォーク版はGitHub Releasesで配布中（最新: `yomuka-v0.3.8.2-fork1.1`・上流ベース`v0.3.8.2`）。
>
> **修正済み**
