...
This document describes all HTTP and WebSocket endpoints available on the Yomuka webserver.
...
Yomuka exposes a webserver for file management and device monitoring:
