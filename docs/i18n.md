...
This guide explains the multi-language support system in CrossPoint Yomuka.

## Overview

CrossPoint Yomuka supports multiple languages for the user interface.

### CJK Fork Additional Languages

In addition to the upstream languages, this CJK fork adds:
...
**Requirements:** CJK UI font must be enabled for proper character display when using Chinese or Japanese.
