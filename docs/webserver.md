...
This guide explains how to connect Yomuka to WiFi and use the built-in web server to upload files from your computer or phone.

## Overview

Yomuka includes a built-in web server that allows you to:
...
1. Ensure your computer is connected to the **same WiFi network** as your Yomuka device
...
1. Ensure your phone/tablet is connected to the **same WiFi network** as your Yomuka device
...
1. Press the **Back** button on your Yomuka device
